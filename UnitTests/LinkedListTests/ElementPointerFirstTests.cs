...
namespace UnitTests.LinkedListTests
{
    ...
    public class ElementPointerFirstTests
    {
        ...
        public unsafe void Test1_Add()
        {
            ...
            LinkedList.ListElement_EPF<int>* firstItem = list.Add(1);
            LinkedList.ListElement_EPF<int>* secondItem = list.Add(2);
            LinkedList.ListElement_EPF<int>* thirdItem = list.Add(3);

            LinkedList.ListElement_EPF<int>*[] items_1 = list.Read();
        ...
        public unsafe void Test2_AddAndRemove()
        {
            ...
            LinkedList.ListElement_EPF<int>*[] items_2 = list.Read();
        ...
        public unsafe void Test3_Write()
        {
            ...
            LinkedList.ListElement_EPF<int>*[] items_3 = list.Read();
