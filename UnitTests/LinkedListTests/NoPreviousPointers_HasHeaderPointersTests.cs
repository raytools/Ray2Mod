...
namespace UnitTests.LinkedListTests
{
    ...
    [TestClass]
    public class NoPreviousPointers_HasHeaderPointersTests
    {

        [TestMethod]
        public unsafe void Test1_Add()
        {
            LinkedList.NoPreviousPointers_HasHeaderPointers<int> list = new LinkedList.NoPreviousPointers_HasHeaderPointers<int>();
            LinkedList.ListElement_NPP_HHP<int>* firstItem = list.Add(1);
            LinkedList.ListElement_NPP_HHP<int>* secondItem = list.Add(2);
            LinkedList.ListElement_NPP_HHP<int>* thirdItem = list.Add(3);

            LinkedList.ListElement_NPP_HHP<int>*[] items_1 = list.Read();
        ...
        public unsafe void Test2_AddAndRemove()
        {
            ...
            LinkedList.ListElement_NPP_HHP<int>*[] items_2 = list.Read();
        ...
        public unsafe void Test3_Write()
        {
            ...
            LinkedList.ListElement_NPP_HHP<int>*[] items_3 = list.Read();
