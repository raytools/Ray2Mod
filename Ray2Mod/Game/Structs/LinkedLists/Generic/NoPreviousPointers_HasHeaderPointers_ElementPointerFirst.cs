...
namespace Ray2Mod.Game.Structs.LinkedLists
{
    ...
    public abstract unsafe partial class LinkedList
    {
        ...
        public unsafe struct NoPreviousPointers_HasHeaderPointers_ElementPointerFirst<T> where T : unmanaged
        {
            ...
            public unsafe ListElement_NPP_HHP_EPF<T>*[] Read()
            {
                ListElement_NPP_HHP_EPF<T>*[] results = new ListElement_NPP_HHP_EPF<T>*[Count];
            ...
            public void Write(ListElement_NPP_HHP_EPF<T>*[] items)
            {
                Count = items.Length;
            ...
            public ListElement_NPP_HHP_EPF<T>* Add(T item)
            {
                ListElement_NPP_HHP_EPF<T>*[] items = Read();

                ListElement_NPP_HHP_EPF<T>* newItem = new ListElement_NPP_HHP_EPF<T>()
                {
                    Next = null,
                    // No Previous Pointers
                    Header = Head,
            ...
            public bool Remove(ListElement_NPP_HHP_EPF<T>* item)
            {
                ListElement_NPP_HHP_EPF<T>*[] items = Read();
