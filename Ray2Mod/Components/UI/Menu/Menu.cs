...
namespace Ray2Mod.Components.UI.Menu
{
    ...
    {
        public Menu(GameFunctions game, params MenuItem[] items) : this(game, new Vector3(3, 13, 0), items) { }

        public Menu(GameFunctions game, Vector3 position, params MenuItem[] items) : this(game, position, 0, items) { }

        public Menu(GameFunctions game, Vector3 position, float width = 0, params MenuItem[] items) : base(game, position)
        {
        ...
        protected override void DrawText()
        {
            for (int i = 0; i < Items.Count; i++)
            {
                ...
                Game.Text.CustomText(name, 9, posX, posY);
            }
        }
